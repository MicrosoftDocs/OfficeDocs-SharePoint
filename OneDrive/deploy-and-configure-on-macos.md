...
|FilesOnDemandEnabled  <br/> |This setting determines whether Files On-Demand is allowed. If this setting is not set, Files On-Demand will be enabled as the feature is released.  <br/> |HydrationDisallowedApps (Bool): When set to true, toasts will not appear when applications trigger the download of file contents.   <br/> |\<key\>FilesOnDemandEnabled</key\><br/><(Bool)/\> <br/> |
|DisableHydrationToast  <br/> |This setting determines if a toast should appear when an application causes a file content’s to be downloaded.   <br/> |FilesOnDemandEnabled (Bool): When set to true, Files On-Demand will be enabled or disabled.  <br/> |\<key\>HydrationDisallowedApps</key\><br/><(Bool)/\> <br/> |
|DisableHydrationToast  <br/> |This setting determines if a toast should appear when an application causes a file content’s to be downloaded.   <br/> |FilesOnDemandEnabled (Bool): When set to true, Files On-Demand will be enabled or disabled.  <br/> |\<key\>HydrationDisallowedApps</key\><br/><(Bool)/\> <br/> |
