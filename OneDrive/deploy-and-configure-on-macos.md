...
|Disable download toasts  <br/> |Prevents toasts from appearing when applications cause file contents to be downloaded   <br/> |HydrationDisallowedToasts (Bool): When set to true, toasts will not appear when applications trigger the download of file contents.   <br/> |\<key\>HydrationDisallowedApps</key\><br/><(Bool)/\> <br/> |
