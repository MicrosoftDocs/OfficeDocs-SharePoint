...
To learn how to set the Enterprise ring for the Windows sync client using Group Policy, see [Receive OneDrive sync client updates on the Enterprise ring
