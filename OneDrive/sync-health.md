...
If you encounter an issue with viewing the report dashboard, first verify that you've completed the troubleshooting steps above.

If issues persist after troubleshooting, please [open a support ticket with Microsoft](/microsoft-365/admin/contact-support-for-business-products?view=o365-worldwide&tabs=phone). Ensure that the device is not powered off during this period so that the sync app can still run and upload a health report.
