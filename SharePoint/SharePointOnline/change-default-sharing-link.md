...
Users can share files and folders in Microsoft SharePoint and Microsoft OneDrive by sending a link. They should select a link type based on the people to whom they want to give permission. The following link types are available: 
