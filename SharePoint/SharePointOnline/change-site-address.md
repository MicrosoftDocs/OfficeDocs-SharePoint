...
**SharePoint webparts**<br>
Any embedded URLs in any SharePoint webparts (News post, List view, etc.) will not be updated and may break. After the site address is changed, you might need to update individual webparts to use the new URL. 
