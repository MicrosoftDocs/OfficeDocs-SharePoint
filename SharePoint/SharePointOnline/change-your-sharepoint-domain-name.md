...
| SharePoint Site Swap | URL of sites swapped, after domain name change is scheduled, won't update the new domain name upon completion of SPO Tenant Rename | Swap sites either prior to domain name being scheduled, or after the domain name change is completed. |
