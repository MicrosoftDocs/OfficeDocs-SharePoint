...
| :------------------:|:------------------- |:----------------|:----------------|:----------------|
| ![Image of two people talking icon.](media/chat-room.png) | **Use Microsoft Viva** | Create personalized employee experiences using different Viva modules in Teams. <br> <br> [Learn more about Viva Connections.](guide-to-setting-up-viva-connections.md)            |Microsoft Teams, SharePoint, SharePoint home site, Global navigation enabled, Viva Connections          |Yammer, Viva Learning, Viva Insights, Viva Topics            |
