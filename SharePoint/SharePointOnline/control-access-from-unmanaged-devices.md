...
To block or limit access to specific sites, you must set the organization-wide policy to "Allow full access from desktop apps, mobile apps, and the web." Then, to manually create a policy in the Azure AD admin center and run PowerShell cmdlets, follow these steps.
