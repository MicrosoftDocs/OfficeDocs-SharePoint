...
|![Image of a networking icon.](media/icon-launch-add.png)|  **Leadership connection**   | Create communication channels and networking opportunities <br> Create engaging experiences in Viva Engage and live events <br> Expand reach using Viva Connections <br><br> [Connect your organization with leaders](leadership-connection.md)|
