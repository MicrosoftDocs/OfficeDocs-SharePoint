...
4. A warning appears, select **Reindex site** again to confirm. The content is reindexed during the next scheduled crawl. 
...
2. In the ribbon, select the **Library** tab or the **List** tab. 
...
2. Scroll down to **Reindex Document Library** or **Reindex List**, and select the button. The content is reindexed during the next scheduled crawl.
