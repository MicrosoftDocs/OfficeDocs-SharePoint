...
> [Why create a custom ranking model?](create-a-custom-ranking-model.md#__toc369771593)
    
> [Get the app for SharePoint Online](create-a-custom-ranking-model.md#__toc369771594)
    
> [Get the app for SharePoint Server 2013](create-a-custom-ranking-model.md#__toc369771595)
    
> [Create a custom ranking model - main steps](create-a-custom-ranking-model.md#__toc369771596)
    
> [Step 1: Copy an existing ranking model and give it a name](create-a-custom-ranking-model.md#__step_1__copy)
    
> [Step 2: Add a judgment set](create-a-custom-ranking-model.md#__step_2__add)
    
> [Step 3: Judge the results for the queries in the set](create-a-custom-ranking-model.md#__step_3__judge)
    
> [Step 4: Add rank features and tune the weight](create-a-custom-ranking-model.md#__step_4__add)
    
> [Step 4a: Add rank features](create-a-custom-ranking-model.md#__toc369771601)
    
> [Step 4b: Tune the weights](create-a-custom-ranking-model.md#__toc369771602)
    
> [Step 5: Evaluate the changes](create-a-custom-ranking-model.md#__step_5__evaluate)
    
> [Step 6: Publish the ranking model](create-a-custom-ranking-model.md#__step_6__publish)
    
> [More info about ranking and ranking models](create-a-custom-ranking-model.md#__toc369771605)
...
1. [Step 1: Copy an existing ranking model and give it a name](create-a-custom-ranking-model.md#__step_1__copy)
    
2. [Step 2: Add a judgment set](create-a-custom-ranking-model.md#__step_2__add)
    
3. [Step 3: Judge the results for the queries in the set](create-a-custom-ranking-model.md#__step_3__judge)
    
4. [Step 4: Add rank features and tune the weight](create-a-custom-ranking-model.md#__step_4__add)
    
5. [Step 5: Evaluate the changes](create-a-custom-ranking-model.md#__step_5__evaluate)
    
6. [Step 6: Publish the ranking model](create-a-custom-ranking-model.md#__step_6__publish)
...
[If the standard SharePoint 2013 ranking models don't satisfy the relevance requirements you have, you can create a custom ranking model. With the Ranking Model Tuning App, you can do this more easily than before. The app provides a user interface for copying an existing ranking model, judge the results for a set of queries, add or remove rank features, and adjust the weight of these features. Finally, you can evaluate the changes, and publish the new ranking model when you're satisfied with the results.](create-a-custom-ranking-model.md#__top)
