...
2. Select **+ Add a card**.
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![Adding a dashboard card](media/add-a-card.png)
...
6. Set the card-display options:
    1. Enter a title for the card in the **Card title** text box. (This title won't change your page title; it is the title that will be displayed on the top of the card.)

   2. Enter a description for the card in the **Card description** text box. This description will be displayed in larger text under the title.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![Adding a tasks card](media/assigned-tasks.png)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![Audience targeting](media/audiences-to-target.png)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![Audience targeting](media/card-targeted-audience.png)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![Audience targeting](media/preview-option.png)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![Audience targeting](media/selecting-groups.png)
...
You can also see how your Dashboard will look on Mobile, Table, and Desktop by selecting those options.
