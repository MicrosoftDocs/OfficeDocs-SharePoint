 ...
 **Everyone except external users** All users you add to your organization automatically become members of Everyone except external users. This group has a default permission level of Contribute. When you grant permissions to this group, all users in your organization can view, add, update, and delete items from lists and libraries (unless you change the default permission level for the group). 
