...
> [!IMPORTANT] 
> It is not recommended to delete the root site collection. If you delete the root site collection, all SharePoint sites in your
> organization will be inaccessible until you restore the site or create a new root site collection.
