...
You must have [Microsoft 365 admin permissions](/microsoft-365/admin/add-users/assign-admin-roles) to access the [Microsoft Purview portal](/microsoft-365/compliance/microsoft-365-compliance-center). 
...
2. In the Microsoft Purview portal Home page, navigate to **Show all** > **eDiscovery** > **Core**.
