...
> [!IMPORTANT]
> External sharing functionality for trial tenants has certain limitations. This is designed to prevent potential abuse and ensure a safe experience for all users. Trial tenants can still utilize SharePoint's robust collaboration features, but the scope of external sharing will be restricted compared to licensed tenants.
