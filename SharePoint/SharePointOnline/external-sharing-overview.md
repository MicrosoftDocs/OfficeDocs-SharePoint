...
> [!NOTE]
> By end of June, old invitations sent via the legacy SharePoint Invitation Manager will no longer grant access to guests. Users can reshare the document with the guest to generate a new, valid invitation 
