...
| ![image of a magnify glass](media/icon-launch-search.png)   | **Improve discoverability**| Next, make sure people in your organization can easily find the home site through a few different entry points in the Microsoft 365 experience. Add a link to the home site in the Microsoft app launcher (sometimes called the waffle) and on the SharePoint start page. Learn more about how to [add a custom tile to the app launcher](/microsoft-365/admin/manage/customize-the-app-launcher?view=o365-worldwide) and how to [add a featured link to the SharePoint start page](https://docs.microsoft.com/sharepoint/change-links-list-on-sharepoint-home-page).|
