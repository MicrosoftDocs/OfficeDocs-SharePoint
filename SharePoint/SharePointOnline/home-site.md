...
- The site will be enabled for [configuring the global navigation in the SharePoint app bar] (https://docs.microsoft.com/SharePoint/sharepoint-app-bar#get-started-customizing-the-global-navigation-tab)
