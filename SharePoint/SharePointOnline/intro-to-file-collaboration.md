...
Files stored in SharePoint and OneDrive in Microsoft 365 are [encrypted in transit and in rest](/microsoft-365/compliance/data-encryption-in-odb-and-spo). (You can [encrypt files by using your own key](/microsoft-365/compliance/controlling-your-data-using-customer-key) if you want.) Files are also [scanned for viruses](/office365/securitycompliance/virus-detection-in-spo). As an admin, you can use tools in Microsoft 365 to further secure and monitor files:
...
- **Microsoft 365 Advanced Threat Protection (ATP)**. [Protect against malicious files](/office365/securitycompliance/atp-for-spo-odb-and-teams).
...
When users in the organization regularly store files in Microsoft 365, they can quickly find recent files and other files that might be of interest. For example, they can [discover files that coworkers or frequent collaborators are working on](https://support.office.com/article/46f92806-b52c-4187-b60e-b3bf8d25f73e).
...
When a Microsoft 365 group is created from anywhere within Microsoft 365, a SharePoint site is automatically created. You can let all users create groups, only some users, or you can block group creation and manage it centrally in your IT department. For info, see [Manage who can create Office groups](/microsoft-365/solutions/manage-creation-of-groups). You can also use a naming policy for groups and set an expiration period so that groups that are no longer being used will be deleted. For more info, see [Plan for governance in Microsoft 365 Groups](/microsoft-365/solutions/collaboration-governance-overview). If you allow users to create groups, you can also allow them to create team sites from the SharePoint start page and from OneDrive and manage default site settings. For info, see [Manage site creation](manage-site-creation.md).

![Site creation settings in the SharePoint admin center](media/site-creation-page.png)

### Sharing

To set up external sharing in your organization, you need to make sure that settings across multiple admin centers are set the way you want. Sharing with people outside your organization is enabled by default in SharePoint, OneDrive, and Teams. See [Collaborate with guests in a team](/microsoft-365/solutions/collaborate-as-team) and [Collaborate with external participants in a channel](/microsoft-365/solutions/collaborate-teams-direct-connect) for information about configuring sharing settings.
