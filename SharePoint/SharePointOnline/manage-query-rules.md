...
> [!IMPORTANT]
> In December 2021 query rules with promoted results are deprecated for organization scoped queries in favor of [Bookmark and Q&A answers](https://docs.microsoft.com/en-us/microsoftsearch/manage-bookmarks) in modern search experiences. Examples of organization scoped queries are SharePoint Home and office.com. <p>Promoted results will continue to work for all classic search experineces and for sites and hub sites with modern search experiences until Bookmark answers are available for these scenarios. Promoted results will also continue to work for environments where Bookmark and Q&A answers are not available.
