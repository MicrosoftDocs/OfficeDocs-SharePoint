...
- Strat_SP_admin
- M365-collaboration
description: Learn how to view and delete site redirects, which are automatically created to ensure that links pointing to the prior URL continue to work.
