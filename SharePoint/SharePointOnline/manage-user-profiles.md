...
>[!NOTE]
>For full OneDrive for Business functionality the user must be a site collection administrator of their OneDrive for Business site. It is not supported to remove this permission.
