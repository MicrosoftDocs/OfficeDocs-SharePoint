...
- The root site can't be connected to a Microsoft 365 group and if using a modern team site then **the publishing feature cannot be activated and may never have been activated on it**.
