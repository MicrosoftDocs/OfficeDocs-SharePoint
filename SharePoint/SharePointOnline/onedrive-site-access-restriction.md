...
1. Select **Allow access restriction** and then select **Save**.
   ...
   :::image type="content" source="./media/rac-spac/1-RAC-SPAC-dashboard-february-2024.png" alt-text="screenshot of site access restriction in sharepoint admin center dashboard." lightbox="media/rac-spac/1-RAC-SPAC-dashboard.png":::
