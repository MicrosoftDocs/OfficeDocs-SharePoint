...
- **Delete partner user accounts** - Delete the partner users from Office 365 provided they no longer need access to any other resources in your organization. See [Delete a user from your organization](/office365/admin/add-users/delete-a-user?redirectSourcePath=%252farticle%252fd5155593-3bac-4d8d-9d8b-f4513a81479e&view=o365-worldwide).
...
[Allow users to contact external Skype for Business users](/SkypeForBusiness/set-up-skype-for-business-online/allow-users-to-contact-external-skype-for-business-users?redirectSourcePath=%252farticle%252fb414873a-0059-4cd5-aea1-e5d0857dbc94)
