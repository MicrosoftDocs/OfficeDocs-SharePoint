...
-   **Plan for up to three levels of navigation**. Local navigation supports up to three levels and a mega-menu experience is coming soon (check the [Office 365 Roadmap](https://products.office.com/en-US/business/office-365-roadmap) *for this and other features that are in development*, rolling out, or launched). A top link can have a sub-link and a sub-link can have and additional level of links. Links to external sites (not on your tenant) automatically open in a new window. Links to pages and sites in the same tenant or on the same site always open in the same window.
