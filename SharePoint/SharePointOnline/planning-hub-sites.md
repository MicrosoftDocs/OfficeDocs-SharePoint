...
|**Created by** <br/> |**Site owner** (unless this has been disabled in your organization) or **admin**.  <br/> |**Site owner** (unless this has been disabled in your organization)  <br/> |[SharePoint site administrators](/sharepoint/site-permissions#site-admins) and [above](./site-permissions) in Microsoft 365  <br/> |
