...
| |![Task list search blue 32](/Office/media/icons/PNGs/search-blue.png "Limit the number of search requests on a page") [Limit the number of search requests on a page](/Office365/Enterprise/modern-search-optimization)|Follow the guidance to limit the number of search requests on a page.|
