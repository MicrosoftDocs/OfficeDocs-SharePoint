...
- **Subsites** – Creation of subsites, for team sites, is available but not recommended. Additionally, a modern communication site as a subsite is not supported. Consider using the modern hub site feature instead. For more info, see [What is a SharePoint hub site?](https://support.microsoft.com/office/what-is-a-sharepoint-hub-site-fe26ae84-14b7-45b6-a6d1-948b3966427f?ui=en-us&rs=en-us&ad=us)
