...
You control your data. When you put your data in SharePoint Online and OneDrive, you remain the owner of the data. For more info about the ownership of your data, see [Microsoft 365 Privacy by Design](https://www.microsoft.com/trustcenter/privacy/privacy-overview).
...
- Use Secure Score to evaluate the security profile of your subscription against a known good baseline, and identify opportunities to increase protection. For more info, see [Introducing the Microsoft 365 Secure Score](/microsoft365/securitycompliance/office-365-secure-score).
