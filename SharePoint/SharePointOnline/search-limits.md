...
|Unique permissions per item <br/> |10,000 <br/> |Boundary <br/> |Items with more than 10,000 unique permissions are not searchable for any user. Such items are only returned for an eDiscovery query through the Security & Compliance center. <br/> ||
