...
1.	Download the latest version of [PowerShell](/powershell/sharepoint/sharepoint-online/connect-sharepoint-onlines).
...
> -	You must be using the latest version of [PowerShell](/powershell/sharepoint/sharepoint-online/connect-sharepoint-online?preserve-view=true&view=sharepoint-ps).
