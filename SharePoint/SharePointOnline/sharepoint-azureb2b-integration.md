...
SharePoint and OneDrive integration with the Azure AD B2B one-time passcode feature is currently not enabled by default, but it is enabled by default for new tenants as of March 31, 2023.
