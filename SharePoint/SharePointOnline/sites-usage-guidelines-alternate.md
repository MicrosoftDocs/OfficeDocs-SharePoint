            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Provide info on how your company has set up sharing. If you have modified the settings from the defaults you can tell your site owners what the sharing settings are for your organization, including for external sharing. </p>Supporting resources for admins: <a href="https://docs.microsoft.com/en-us/sharepoint/plan-your-permissions-strategy">Plan your permissions strategy</a> </p></p><b>Sample text:</b></p><i>Your site and its contents can be shared with anyone in the organization.</i> </p></p>or </p> </p><i>As the site owner you will receive access requests when someone shares your site that you can approve or decline.</i></p>    </div>
                </div>
            </div>
        </div>
    </li>
