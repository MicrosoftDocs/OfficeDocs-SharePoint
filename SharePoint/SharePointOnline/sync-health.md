...
> [!NOTE]
> OneDrive sync health reports can also be enabled using administrative templates in Intune through the **Enable sync health reporting for OneDrive** setting. For more information, see [Use administrative templates in Intune](configure-sync-intune.md).
