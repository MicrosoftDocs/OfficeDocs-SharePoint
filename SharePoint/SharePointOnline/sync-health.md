...
> [!NOTE]
> OneDrive sync health reports can also be enabled using administrative templates in Intune through the _Enable sync health reporting for OneDrive_ setting. For more information, see [Use administrative templates in Intune](configure-sync-intune.md).
