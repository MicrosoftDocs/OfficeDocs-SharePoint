...
### [Manage connecting classic team sites to new Office 365 groups](manage-connecting-classic-team-sites-to-new-office-365-groups.md)
...
#### [Create a custom ranking model by using the Ranking Model Tuning App](create a custom ranking model by using the ranking model tuning app.md)
