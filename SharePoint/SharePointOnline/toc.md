...
#### [Overview](restricted-sharepoint-search.md)
#### [Curate allowed list](restricted-sharepoint-search-allowed-list.md)
#### [Use PowerShell admin scripts](restricted-sharepoint-search-admin-scripts.md)
## [Classic to modern]()
...
#### [Configure settings with Intune](configure-sync-intune.md)
...
### [Manage site version limits (Preview)]()
#### [Set site version limits(Preview)](site-version-limits.md)
#### [Generate version storage usage report(Preview)](version-storage-report-site.md)
### [Set library version limits (Preview)](library-version-limits.md)
### [Change OneDrive version limits (Preview)](version-limits-onedrive-ps.md)
### [Trim versions (Preview)](trim-versions.md)
### [Tutorials(Preview)]()
...
### [Privacy, security, and compliance in Microsoft OneDrive](onedrive-privacy-security-overview.md)
