...
>
> The _Silently sign in users to the OneDrive sync app with their Windows credentials_ feature works for computers that are joined to Azure Active Directory (Azure AD).
