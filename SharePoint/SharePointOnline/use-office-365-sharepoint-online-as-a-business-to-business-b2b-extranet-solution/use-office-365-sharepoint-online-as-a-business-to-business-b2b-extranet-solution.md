...
3. Deploy your extranet by using [standard SharePoint Online sharing options](../manage-external-sharing/manage-external-sharing.md) or by [importing external users into Azure AD](https://docs.microsoft.com/azure/active-directory/active-directory-b2b-what-is-azure-ad-b2b).
