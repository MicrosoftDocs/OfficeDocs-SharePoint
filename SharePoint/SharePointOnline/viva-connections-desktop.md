...
> - Viva Connections desktop is not supported on mobile or tablet devices. Please use the upgraded app from [Set up and launch Viva Connections](https://learn.microsoft.com/en-us/viva/connections/guide-to-setting-up-viva-connections) to include the mobile experience. 
