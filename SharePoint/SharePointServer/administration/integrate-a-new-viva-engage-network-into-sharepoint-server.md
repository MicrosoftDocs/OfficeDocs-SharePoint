...
description: "Learn how to integrate a new Viva Engage Enterprise network into an existing SharePoint Server environment."
---
...
This scenario describes the prerequisites and recommended steps to integrate a new Viva Engage Enterprise network together with your existing SharePoint Server environment.
...
- You are ready to use a Viva Engage Enterprise network.
    
## Step 1: Purchase Viva Engage Enterprise

Viva Engage Enterprise is included in many Microsoft 365 subscriptions, which means that you might already have licenses for the service. 
...
Microsoft 365 uses Azure Active Directory for identity management, and Viva Engage Enterprise can be set up to enforce Microsoft 365 identity. If you're using an on-premises directory, in order to manage users in one place, you need to sync your on-premises directory with Azure Active Directory by using Azure Active Directory Connect. 
