...
> [!IMPORTANT]
> Planning your user management is fundamental to deploying Microsoft 365 and Viva Engage Enterprise. To understand how user management works, it's important to understand that Microsoft 365 uses Microsoft Azure Active Directory to provide authentication to Microsoft 365 services, including Viva Engage Enterprise. This means Microsoft 365 uses the identity that is synchronized with Azure AD to provide authentication. 
