...
> [!IMPORTANT]
> If you're using SharePoint Server and SQL Server AlwaysOn Availability Groups before moving the databases, you should point to the AG Listner. If you are moving from a single-server to an AlwayOn Availability Group then you should use the cliconfg.exe.
