...
> [!NOTE]
> SharePoint Server Subscription Edition supports client certificate authentication and administrators can pick a specific certificate for SMTP TLS encryption using the **Use Client Certificate Authentication** and **Client Certificate** settings.
