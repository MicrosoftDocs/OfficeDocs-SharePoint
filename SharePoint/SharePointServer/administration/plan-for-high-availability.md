...
For general information about database mirroring, see [Database Mirroring](/sql/database-engine/database-mirroring/database-mirroring-sql-server?viewFallbackFrom=sql-server-2014).
