...
- [Introduction](plan-for-high-availability.md#Intro)
    
- [Create a farm architecture that supports high availability](plan-for-high-availability.md#HAArchitecture)
    
- [Use fault tolerance in your high availability solution](plan-for-high-availability.md#UseFT)
    
- [Configure two data centers as a single farm ("stretched" farm) to provide high availability](plan-for-high-availability.md#CfgStretchedFarm)
    
- [Incorporate backup and restore operations in a high availability strategy](plan-for-high-availability.md#BckResOpts)
