...
> [!NOTE]
> For a list of supported directory services, see the [](profile-synchronization-in-sharepoint-server-2013.md#supported) section in the "Profile synchronization overview" article. 
