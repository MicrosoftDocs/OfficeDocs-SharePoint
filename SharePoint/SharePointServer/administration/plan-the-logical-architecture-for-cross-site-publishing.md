...
description: "Summary: Learn about components and typical architectures for SharePoint Server cross-site publishing sites."
---

# Plan the logical architecture for cross-site publishing in SharePoint Server

 **Summary:** Learn about components and typical architectures for SharePoint Server cross-site publishing sites. 
