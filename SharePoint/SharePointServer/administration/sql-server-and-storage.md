...
|[Deploy SharePoint Server with Azure SQL Managed Instance](../administration/deploy-azure-sql-managed-instance-with-sharepoint-servers.md) <br/> |Describes how to deploy Azure SQL Managed Instance with SharePoint Servers 2016 and 2019 that are hosted in Microsoft Azure.  <br/> |
