...
|[Discover view](/onedrive/help-users-use-discover-view?redirectSourcePath=%252farticle%252feffbf250-57c8-436d-9e0f-edd017a896b7)|A list of relevant content they have access to, based on who they work with and what they're working on. <br>This depends on integration with the Office Graph, which admins can control in the **Settings** tab in the SharePoint admin center.|From a user's OneDrive for Business, select **Discover**.|
...
1.	Assign yourself admin permissions to the user's OneDrive for Business account. This can be done [in the Office 365 admin center](/office365/admin/add-users/get-access-to-and-back-up-a-former-user-s-data?redirectSourcePath=%252farticle%252fa6f7f9ad-e3f5-43de-ade5-e5a0d7531604&view=o365-worldwide).
