...
|**Content**|**Description**|
|:-----|:-----|
|[Configure hybrid OneDrive for Business - roadmap](configure-hybrid-onedrive-for-businessroadmap.md) <br/> |With hybrid OneDrive for Business, users will be redirected to OneDrive for Business in Microsoft 365 when they click the **OneDrive** link in SharePoint Server.  <br/> |
...
|[Configure cloud hybrid search - roadmap](configure-cloud-hybrid-searchroadmap.md) <br/> |With cloud hybrid search, you have a single search index in Microsoft 365 for enterprises with content from SharePoint Server and SharePoint Online.  <br/> |
