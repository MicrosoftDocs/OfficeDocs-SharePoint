...
|:-----|:-----|:-----|
|Azure Application Proxy|[Enable remote access to SharePoint in Microsoft 365 with Microsoft Entra application proxy](/azure/active-directory/manage-apps/application-proxy-integrate-with-sharepoint-server)|Azure Application Proxy is an Azure service that allows remote access to services within your network without opening firewall ports from the Internet to your service.|
...
|Citrix NetScaler  <br/> |[Citrix NetScaler and Microsoft SharePoint 2013 Hybrid Deployment Guide](https://1library.net/document/y6ewkrx7-citrix-netscaler-microsoft-sharepoint-hybrid-deployment-guide.html?formCode=MG0AV3#google_vignette) <br/> |External content managed by Citrix.  <br/> |
