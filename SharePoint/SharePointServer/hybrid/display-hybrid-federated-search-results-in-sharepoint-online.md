...
For more information about result sources, see [Understanding result sources](http://office.microsoft.com/en-us/support/sharepoint-help/sharepointsearch/understanding-result-sources-HA102848849.aspx?CTT=5&amp;origin=HA103639370) and [Manage result sources](https://docs.microsoft.com/en-us/sharepoint/manage-result-sources).
