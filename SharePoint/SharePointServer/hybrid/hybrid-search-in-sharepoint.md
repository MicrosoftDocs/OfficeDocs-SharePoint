...
description: Learn about Hybrid search, which lets users search for files and documents across SharePoint Server and Office 365, and how to configure Hybrid search.
---
