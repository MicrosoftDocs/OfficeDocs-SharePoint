...
The values in the following table are minimum values for installations on a web and application servers that are running SharePoint Server 2019 in a multiple server farm installation.
