...
5. If the **Modify SharePoint Central Administration Web Administration Settings** page appears, don't change any of the default settings, and then click **Next**.
