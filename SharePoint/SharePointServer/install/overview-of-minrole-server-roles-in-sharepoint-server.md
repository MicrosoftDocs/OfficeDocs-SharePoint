...
[Planning for a MinRole server deployment in SharePoint Servers 2016 and 2019 Public Preview](planning-for-a-minrole-server-deployment-in-sharepoint-server.md)
