...
|Maximum Access app database storage size in SQL Azure  <br/> |1 Gb  <br/> |Boundary  <br/> |Each Access app created on SharePoint creates a database on SQL Azure. 1 GB is the limit for the database storage on SQL Azure. In an on-premise installation, the administrator controls the size of the associated SQL database.  <br/> |
