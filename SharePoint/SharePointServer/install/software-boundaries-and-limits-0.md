...
|Text length for queries on the SharePoint home page  <br/> |16 KB (16,384 characters)  <br/> |Supported  <br/> |This is the tested and default value for the maximum text length for a query used on the SharePoint home page. The default value for the maximum text length can be increased up to the boundary of 20 KB (20,480).  <br/> |
