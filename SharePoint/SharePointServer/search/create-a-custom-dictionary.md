...
8.  In the **Save in** list, browse to the folder that contains the word breakers. By default, this folder is %ProgramFiles%\\Microsoft Office Servers\\14.0\\Bin for SharePoint 2010, %ProgramFiles%\\Microsoft Office Servers\\15.0\\Bin for SharePoint 2013 and %ProgramFiles%\\Microsoft Office Servers\\16.0\\Bin for Sharepoint 2016 and SharePoint 2019.
...
2.  On each application server in the farm, copy the new custom dictionary file to the folder that contains the word breakers. By default, this folder is %ProgramFiles%\\Microsoft Office Servers\\14.0\\Bin for SharePoint 2010, %ProgramFiles%\\Microsoft Office Servers\\15.0\\Bin for SharePoint 2013 and %ProgramFiles%\\Microsoft Office Servers\\16.0\\Bin for Sharepoint 2016 and SharePoint 2019..
