...
description: "Summary: Use a result source in SharePoint Server to specify a provider to get search results from for the classic search experience, and optionally to narrow a search to a subset of those results."
---

# Understanding result sources for search in SharePoint Server

 **Summary:** Use a result source in SharePoint Server to specify a provider to get search results from for the classic search experience, and optionally to narrow a search to a subset of those results. 
  
This article provides a brief overview of result sources in SharePoint Server. 

> [!IMPORTANT]
> The modern search experience in SharePoint Server 2019 Public Preview gets it's results from the default result source. If you change the default result source it impacts both the classic and modern search experiences.
