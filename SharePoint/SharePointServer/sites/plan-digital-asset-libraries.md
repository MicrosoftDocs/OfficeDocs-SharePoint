...
For more information about the media formats that are supported by Silverlight media players, see [Supported Media Formats, Protocols, and Log Fields](https://msdn.microsoft.com/library/cc189080%28VS.95%29.aspx).
