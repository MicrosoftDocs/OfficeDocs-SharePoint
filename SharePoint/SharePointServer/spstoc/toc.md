...
##### [Overview of the services upgrade process](../upgrade-and-update/overview-of-the-services-upgrade-process-subscription-edition.md)
...
##### [Deploying SharePoint Server with SQL Server AlwaysOn Availability Groups in Azure](../administration/deploying-sharepoint-server-with-sql-server-alwayson-availability-groups-in.md)
