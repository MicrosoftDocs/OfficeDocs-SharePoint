...
#### [System requirements for SharePoint Server 2016](../install/system-requirements-for-sharepoint-server-2016.md)
...
##### [Overview of MinRole Server Roles in SharePoint Server 2016](../install/overview-of-minrole-server-roles-in-sharepoint-server-2016.md)
##### [Planning for a MinRole server deployment in SharePoint Server 2016](../install/planning-for-a-minrole-server-deployment-in-sharepoint-server-2016.md)
...
### [List Templates supported by the SharePoint Migration Tool ](../migrate-to-sharepoint-online/sharepoint-migration-supported-list-templates.md)
### [How to format your CSV or Json file for data content migration](../migrate-to-sharepoint-online/how-to-format-your-csv-file-for-data-content-migration.md)
...
### [SharePoint Migration Assessment Tool:  Scan Reports Roadmap](../migrate-to-sharepoint-online/sharepoint-migration-assessment-toolscan-reports-roadmap.md)
#### [Migration Assessment Scan: Apps](../migrate-to-sharepoint-online/migration-assessment-scan-apps.md)
#### [Migration Assessment Scan: Alerts](../migrate-to-sharepoint-online/migration-assessment-scan-alerts.md)
#### [Migration Assessment Scan: BCS](../migrate-to-sharepoint-online/migration-assessment-scan-bcs.md)
#### [Migration Assessment Scan: Browser File Handling](../migrate-to-sharepoint-online/migration-assessment-scan-browser-file-handling.md)
#### [Migration Assessment Scan: Checked-out files](../migrate-to-sharepoint-online/migration-assessment-scan-checked-out-files.md)
#### [Migration Assessment Scan: Custom Profile Property Mappings](../migrate-to-sharepoint-online/migration-assessment-scan-custom-profile-property-mappings.md)
#### [Migration Assessment Scan: Customized Pages](../migrate-to-sharepoint-online/migration-assessment-scan-customized-pages.md)
#### [Migration Assessment Scan: Customized Profile Pages](../migrate-to-sharepoint-online/migration-assessment-scan-customized-profile-pages.md)
#### [Migration Assessment Scan: File Versions](../migrate-to-sharepoint-online/migration-assessment-scan-file-versions.md)
#### [Migration Assessment Scan: InfoPath](../migrate-to-sharepoint-online/migration-assessment-scan-infopath.md)
#### [Migration Assessment Scan: IRM Enabled Lists](../migrate-to-sharepoint-online/migration-assessment-scan-irm-enabled-lists.md)
#### [Migration Assessment Scan: Large Excel Files](../migrate-to-sharepoint-online/migration-assessment-scan-large-excel-files.md)
#### [Migration Assessment Scan: Large List Views](../migrate-to-sharepoint-online/migration-assessment-scan-large-list-views.md)
#### [Migration Assessment Scan: Large Lists](../migrate-to-sharepoint-online/migration-assessment-scan-large-lists.md)
#### [Migration Assessment Scan: Large Sites](../migrate-to-sharepoint-online/migration-assessment-scan-large-sites.md)
#### [Migration Assessment Scan: Locked Sites](../migrate-to-sharepoint-online/migration-assessment-scan-locked-sites.md)
#### [Migration Assessment Scan: Long OneDrive URLs](../migrate-to-sharepoint-online/migration-assessment-scan-long-onedrive-urls.md)
#### [Migration Assessment Scan: Master Pages](../migrate-to-sharepoint-online/migration-assessment-scan-master-pages.md)
#### [Migration Assessment Scan: Secure Store](../migrate-to-sharepoint-online/migration-assessment-scan-secure-store.md)
#### [Migration Assessment Scan: Unsupported Site Templates](../migrate-to-sharepoint-online/migration-assessment-scan-unsupported-site-templates.md)
#### [Migration Assessment Scan: Web Application Policies](../migrate-to-sharepoint-online/migration-assessment-scan-web-application-policies.md)
#### [Migration Assessment Scan: Workflow Associations 2010](../migrate-to-sharepoint-online/migration-assessment-scan-workflow-associations-2010.md)
#### [Migration Assessment Scan: Workflow Associations 2013](../migrate-to-sharepoint-online/migration-assessment-scan-workflow-associations-2013.md)
#### [Migration Assessment Scan: Full Trust Component Results](../migrate-to-sharepoint-online/migration-assessment-scan-full-trust-component-results.md)
#### [Migration Assessment Scan: Email Enabled Lists](../migrate-to-sharepoint-online/migration-assessment-scan-email-enabled-lists.md)
#### [Migration Assessment Scan: Sandbox Solution](../migrate-to-sharepoint-online/migration-assessment-scan-sandbox-solution.md)
#### [Migration Assessment Scan: Workflow Running Solutions 2010](../migrate-to-sharepoint-online/migration-assessment-scan-workflow-running-solutions-2010.md)
#### [Migration Assessment Scan: Workflow Running Solutions 2013](../migrate-to-sharepoint-online/migration-assessment-scan-workflow-running-solutions-2013.md)
#### [Migration Assessment Scan: Managed Metadata Columns](../migrate-to-sharepoint-online/migration-assessment-scan-managed-metadata-columns.md)
#### [Migration Assessment Scan:  Publishing Pages](../migrate-to-sharepoint-online/migration-assessment-scanpublishing-pages.md)
#### [Migration Assessment Scan: Publishing Sites](../migrate-to-sharepoint-online/migration-assessment-scan-publishing-sites.md)
#### [Migration Assessment Scan: Site Template Language](../migrate-to-sharepoint-online/migration-assessment-scan-site-template-language.md)
#### [Migration Assessment Scan: Custom Permission Level](../migrate-to-sharepoint-online/migration-assessment-scan-custom-permission-level.md)
#### [Migration Assessment Scan: External List](../migrate-to-sharepoint-online/migration-assessment-scan-external-list.md)
### [SharePoint Migration Identity Mapping Tool](../migrate-to-sharepoint-online/sharepoint-migration-identity-mapping-tool.md)
#### [SharePoint Migration Identity Mapping Tool: SharePoint Identity Scan](../migrate-to-sharepoint-online/sharepoint-migration-identity-mapping-tool-sharepoint-identity-scan.md)
#### [SharePoint Migration Identity Mapping: Active Directory Identity Scan](../migrate-to-sharepoint-online/sharepoint-migration-identity-mapping-active-directory-identity-scan.md)
#### [SharePoint Migration Identity Mapping Tool: Azure Active Directory Identity Scan](../migrate-to-sharepoint-online/sharepoint-migration-identity-mapping-tool-azure-active-directory-identity-scan.md)
...
#### [Uninstall SharePoint Server 2016](../administration/uninstall-sharepoint-server-2016.md)
#### [Custom Tiles in SharePoint Server 2016](../administration/custom-tiles-in-sharepoint-server-2016.md)
#### [Configure server-to-server authentication in SharePoint](../administration/configure-server-to-server-authentication-in-sharepoint.md)
...
#### [Microsoft Identity Manager in SharePoint Server 2016](../administration/microsoft-identity-manager-in-sharepoint-server-2016.md)
##### [Install Microsoft Identity Manager for User Profiles in SharePoint Server 2016](../administration/install-microsoft-identity-manager-for-user-profiles-in-sharepoint-server-2016.md)
###### [Use a sample MIM solution in SharePoint Server 2016](../administration/use-a-sample-mim-solution-in-sharepoint-server-2016.md)
##### [Overview of Microsoft Identity Manager Synchronization Service  in SharePoint Server 2016](../administration/overview-of-microsoft-identity-manager-synchronization-service-in-sharepoint-ser.md)
##### [Deployment considerations for implementing Microsoft Identity Manager with SharePoint Server 2016](../administration/deployment-considerations-for-implementing-microsoft-identity-manager-with-share.md)
...
### [Integrate Yammer with on-premises SharePoint 2013 environments](../administration/integrate-yammer-with-on-premises-sharepoint-2013-environments.md)
#### [Yammer networks, groups, and users overview](../administration/yammer-networks-groups-and-users-overview.md)
#### [Social scenarios with Yammer and SharePoint Server 2013](../administration/social-scenarios-with-yammer-and-sharepoint-server-2013.md)
##### [Integrate a new Yammer network into SharePoint Server 2013](../administration/integrate-a-new-yammer-network-into-sharepoint-server-2013.md)
##### [Integrate a single Yammer network into SharePoint Server 2013](../administration/integrate-a-single-yammer-network-into-sharepoint-server-2013.md)
##### [Integrate multiple Yammer networks into SharePoint Server 2013](../administration/integrate-multiple-yammer-networks-into-sharepoint-server-2013.md)
##### [Integrate a Yammer network into SharePoint Server 2013 with social features](../administration/integrate-a-yammer-network-into-sharepoint-server-2013-with-social-features.md)
##### [Integrate a Yammer network into SharePoint Server 2013 and Office 365](../administration/integrate-a-yammer-network-into-sharepoint-server-2013-and-office-365.md)
#### [Add Yammer to the navigation bar for SharePoint 2013](../administration/add-yammer-to-the-navigation-bar-for-sharepoint-2013.md)
#### [Hide SharePoint Server 2013 social features](../administration/hide-sharepoint-server-2013-social-features.md)
#### [Get and install the Yammer app onto SharePoint Server 2013 sites](../administration/get-and-install-the-yammer-app-onto-sharepoint-server-2013-sites.md)
...
#### [Alternate access URLs have not been configured](../technical-reference/alternate-access-urls-have-not-been-configured.md)
...
#### [Database has large amounts of unused space](../technical-reference/database-has-large-amounts-of-unused-space.md)
...
#### [Search - One or more crawl databases may have fragmented indices](../technical-reference/searchone-or-more-crawl-databases-may-have-fragmented-indices.md)
...
#### [Validate the My Site Host and individual My Sites are on a dedicated Web application and separate URL domain](../technical-reference/validate-the-my-site-host-and-individual-my-sites-are-on-a-dedicated-web-applica.md)
...
### [Timer job reference for SharePoint Server 2016](../technical-reference/timer-job-reference-for-sharepoint-server-2016.md)
### [Timer job reference for SharePoint 2013](../technical-reference/timer-job-reference-for-sharepoint-2013.md)
