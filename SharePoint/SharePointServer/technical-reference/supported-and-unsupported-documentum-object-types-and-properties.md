...
description: "Summary: Learn which object types and properties the SharePoint Server Indexing Connector for Documentum supports or does not support."
---

# Supported and unsupported Documentum object types and properties in SharePoint Server

 **Summary:** Learn which object types and properties the SharePoint Server Indexing Connector for Documentum supports or does not support. 
