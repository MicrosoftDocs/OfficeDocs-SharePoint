...
|Hybrid <br/> | <ul><li>Better integration with Power Apps and Power Automate</li><li>Cloud hybrid search (Cloud SSA) supports hybrid data residence on multiple regions</li><li>Improved hybrid search troubleshooting</li></ul> | <ul><li>For more information, see [Power Apps and Power Automate integration](#power).</li><li>For more information, see [Cloud hybrid search (Cloud SSA) supports hybrid data residence on multiple regions](#ssa).</li><li>For more information, see [Improved hybrid search troubleshooting](#ihst).</li></ul> | 
