...
You can use the SharePoint Central Administration website to configure diagnostic logging. **To configure diagnostic logging by using Central Administration**
