...
2. Run the **Microsoft SharePoint Products and Technologies 2016 Preparation Tool,** to install all the prerequisites to set up and use SharePoint Server 2016.
