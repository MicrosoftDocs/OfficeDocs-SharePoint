...
11. For each primary index component, monitor the index repartitioning progress. At the Windows PowerShell command prompt of the second SharePoint 2016 Management Shell, type the following command(s):
