...
However, there is a technical challenge to generate the property values for 'AllUsersProperties' and 'PerUserProperties' when building the PRIME package. This is because these property values are BASE64 encoded blob, which are serialized web part properties and web part connection info. 
