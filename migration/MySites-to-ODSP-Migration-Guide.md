...
|:-----|:-----|:-----|
|[File Versions](https://docs.microsoft.com/en-us/sharepointmigration/migration-assessment-scan-file-versions) |The more versions of a file you have, the longer it will take to migrate. Note: By default, versioning is enabled for all lists and libraries on the target platform. In the destination SPO site, there is no limit when versioning is enabled.|Action:  Consider limiting the number of versions you migrate.||
