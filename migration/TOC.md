...
#### [Box to Office 365](auth-connector-box.md)
#### [Dropbox to Office 365](auth-connector-dropbox.md)
#### [Egnyte to Office 365](auth-connector-egnyte.md)
#### [File shares to Office 365](auth-connector-fileshare.md)
#### [G Suite Drive to Office 365](auth-connector-gsuite.md)
#### [Amazon WorkDocs to Office 365](auth-connector-amazonworkdocs.md)
#### [Office 365 to Office 365](auth-connector-o365.md)
#### Other Connectors
##### [Amazon S3 to Office 365](auth-connector-amazons3.md)
##### [Azure Blob Storage to Office 365](auth-connector-azureblob.md)
##### [Google Cloud Storage to Office 365](auth-connector-googlecloudstore.md)
##### [FTP to Office 365](auth-connector-ftp.md)
##### [SFTP to Office 365](auth-connector-sftp.md)
##### [NetDocuments to Office 365](auth-connector-netdocuments.md)
##### [WedDAV to Office 365](auth-connector-webdav.md)
