...
### [SharePoint Migration Tool Installation prerequisites](spmt-prerequisites.md)
### [File and folder permissions when using SPMT](understanding-permissions-when-migrating.md)
### [SPMT Settings](spmt-settings.md)
### [Using the SharePoint Migration Tool](how-to-use-the-sharepoint-migration-tool.md)
### [How to create a user mapping file for use with SPMT](create-a-user-mapping-file-for-data-content-migration.md)
### [SPMT Supported SharePoint list templates](sharepoint-migration-supported-list-templates.md)
