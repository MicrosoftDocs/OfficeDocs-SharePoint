...
#### [Scan report: Alerts](migration-assessment-scan-alerts.md)
#### [Scan report: BCS](migration-assessment-scan-bcs.md)
#### [Scan report: Browser File Handling](migration-assessment-scan-browser-file-handling.md)
#### [Scan report: Checked-out files](migration-assessment-scan-checked-out-files.md)
#### [Scan report: Custom Profile Property Mappings](migration-assessment-scan-custom-profile-property-mappings.md)
#### [Scan report: Customized Pages](migration-assessment-scan-customized-pages.md)
#### [Scan report: Customized Profile Pages](migration-assessment-scan-customized-profile-pages.md)
#### [Scan report: File Versions](migration-assessment-scan-file-versions.md)
#### [Scan report: InfoPath](migration-assessment-scan-infopath.md)
#### [Scan report: IRM Enabled Lists](migration-assessment-scan-irm-enabled-lists.md)
#### [Scan report: Large Excel Files](migration-assessment-scan-large-excel-files.md)
#### [Scan report: Large List Views](migration-assessment-scan-large-list-views.md)
#### [Scan report: Large Lists](migration-assessment-scan-large-lists.md)
#### [Scan report: Large Sites](migration-assessment-scan-large-sites.md)
#### [Scan report: Locked Sites](migration-assessment-scan-locked-sites.md)
#### [Scan report: Long OneDrive URLs](migration-assessment-scan-long-onedrive-urls.md)
#### [Scan report: Master Pages](migration-assessment-scan-master-pages.md)
#### [Scan report: Secure Store](migration-assessment-scan-secure-store.md)
#### [Scan report: Unsupported Site Templates](migration-assessment-scan-unsupported-site-templates.md)
#### [Scan report: Web Application Policies](migration-assessment-scan-web-application-policies.md)
#### [Scan report: Workflow Associations 2010](migration-assessment-scan-workflow-associations-2010.md)
#### [Scan report: Workflow Associations 2013](migration-assessment-scan-workflow-associations-2013.md)
#### [Scan report: Full Trust Component Results](migration-assessment-scan-full-trust-component-results.md)
#### [Scan report: Email Enabled Lists](migration-assessment-scan-email-enabled-lists.md)
#### [Scan report: Workflow Running Solutions 2010](migration-assessment-scan-workflow-running-solutions-2010.md)
#### [Scan report: Workflow Running Solutions 2013](migration-assessment-scan-workflow-running-solutions-2013.md)
#### [Scan report: Managed Metadata Columns](migration-assessment-scan-managed-metadata-columns.md)
#### [Scan report:  Publishing Pages](migration-assessment-scanpublishing-pages.md)
#### [Scan report: Publishing Sites](migration-assessment-scan-publishing-sites.md)
#### [Scan report: Site Template Language](migration-assessment-scan-site-template-language.md)
#### [Scan report: Custom Permission Level](migration-assessment-scan-custom-permission-level.md)
#### [Scan report: External List](migration-assessment-scan-external-list.md)
