...
|0x0201000E|Invalid SharePoint path|Check if the global setting has filtered out some special characters in the target path or if the path has unsupported characters like ""'\u007f',  '<', '?', '>', '*', '|', or '""'|
