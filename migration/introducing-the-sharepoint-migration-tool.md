...
>
>The SharePoint Migration Tool can also be used inconjunction with [Azure Data Box](how-to-migrate-file-share-content-to-SPO-using-AzureDataBox.md) for migrating file server content to SharePoint Online.
