...
|Get started migrating |Description|
|:-----|:-----|
|![Get started **Box**](https://docs.microsoft.com/office/media/icons/get-started-blue.png) [Box](mm-box-overview.md)|Collaborate all in one place by migrating your Box documents, data, and users to OneDrive, SharePoint, and Teams in Microsoft 365. |
|![Get started File share](https://docs.microsoft.com/office/media/icons/get-started-blue.png) [File share](mm-get-started.md)|Migration Manager lets you have a centralized way of connecting servers, creating tasks, and automatically load balancing your migration tasks. You're guided through the steps of migrating your file shares, from the setup of agents, the creation of tasks, and the final migration to Microsoft 365. You can specify global or task level settings, view all-up task progress, and download aggregated summary and task level reports.|
|![Get started Google Workspace](https://docs.microsoft.com/office/media/icons/get-started-blue.png) [Google Drives](mm-google-overview.md)|Collaborate all in one place by migrating your Google documents, data, and users to OneDrive, SharePoint, and Teams in Microsoft 365. |
|![Get started Dropbox](https://docs.microsoft.com/office/media/icons/get-started-blue.png) [Dropbox](mm-dropbox-overview.md)|Collaborate all in one place by migrating your Dropbox documents, data, and users to OneDrive, SharePoint, and Teams in Microsoft 365. |
|![Get started SharePoint Server](https://docs.microsoft.com/office/media/icons/get-started-blue.png) [SharePoint Server](mm-box-overview.md)|Migrate your SharePoint Server sites and content to take advantage of the latest collaboration, intelligence, and security solutions in Microsoft 365. The modern experience features in Microsoft SharePoint are designed to be compelling, flexible, and more performant. Migrate your SharePoint Server 2010, 2013, and 2016 environments.|
|![Get started SharePoint Server workflows](https://docs.microsoft.com/office/media/icons/get-started-blue.png) [SharePoint Server workflows](mm-box-overview.md)|Microsoft removed **SharePoint Server 2010** workflow services from existing tenants on November 1, 2020. We recommend that you move your classic SharePoint Server workflows to Power Automate flows. With SPMT you can migrate your **SharePoint Server 2010** out of the box (OOTB) approval and collect feedback workflows to PowerAutomate, List and library "out-of-box" (OOTB) approval workflows, and Workflow definitions and associations.|
