...
For more information on permission levels, see [How to create and edit Permission Levels](https://docs.microsoft.com/sharepoint/how-to-create-and-edit-permission-levels).
