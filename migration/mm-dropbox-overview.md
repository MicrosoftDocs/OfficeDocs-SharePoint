...
>[!Note]
>This release currently supports the migration of up to approximately 10,00 Dropbox accounts in a single migration. For larger migrations, we recommend you use the [Mover migration tool](https://Mover.io).
