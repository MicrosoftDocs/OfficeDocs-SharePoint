...
![Format for bulk uploading Egnyte source files into Migration Manager](media/mm-dropbox-csv-format.png)
...
![Add Egnyte source paths](media/mm-dropbox-add-source-path.png)
