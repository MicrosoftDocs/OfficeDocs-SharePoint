...
>[!Note]
> Starting your migration **does not remove anyting from Google Workspace** and just copies content from your Google account to the location you have specified in Microsoft 365.  Make sure the destinations are correct, as once the migration starts, they cannot be modified.
