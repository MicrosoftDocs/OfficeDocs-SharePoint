...
- **Workaround for Geo admins**. Migration currently doesn't support the Geo admin role. See [Workaround for Geo admins using Migration Manager](mm-troubleshooting.md)
- **Workaround for Azured-acquired admins**. SharePoint admins created via groups can't access Migration Manager scan and migration tabs.  See [Workaround for Group-inherited SharePoint Admins using Migration Manager](mm-troubleshooting.md)
