...
![Edit Permission Map button](media/edit-permission-map.png)
...
![Permission map auto-discover prompt](media/permission-map-auto-discover-users.png)

3. You may view and edit your permission map at any time.

![Permission map overview](media/permission-map.png)

>[!Note:]
> A blank destination entry will automatically cancel any permissions sharing for that user or group.

>[!Note:]
> Adding a new line for a specific users - ie. user01@gmail.com to user01@hotmail.com - that perfectly matches auto-discovered permissions by the domain - ie. @gmail.com to @hotmail.com - will be automatically removed; as the application marks these as redundant entries.
