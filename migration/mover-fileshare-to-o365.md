...
No, it doesn't interact with the OneDrive sync app. We recommend disabling the sync app before a migration. If it's running during a migration, it tries to sync all the migrating data.
