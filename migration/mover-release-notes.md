...
Important!
## ## DEPLOY PRODUCTION - backend @ v1.16.2
...
 
[5/25 3:06 PM] Diego Luces
## DEPLOY PRODUCTION - backend @ v1.16.1
...
[5/22 2:30 PM] Diego Luces
Important!
Removal of Legacy "SharePoint Online" and "OneDrive for Business (Administrator)" Connectors
Mover team! This is to inform you that we have removed these two legacy connectors that are now offered under the umbrella Office 365 connector.
Context
- In Q4 2019 we introduced our Office 365 connector 
- Right after, we announced deprecation of our SharePoint Online and OneDrive for Business (Administrator) connectors 
- We emailed users that had those connectors letting them know that would happen and when (May 1, 2020) and what they could do to retain functionality (authorize a new O365 connector) 
- Up until now, whenever a customer would raise issues with the deprecated connectors, we would respond with a strong suggestion to upgrade to the O365 connector and we would remind them of the deadline. 
So what happened today?
- We removed all SharePoint Online and OneDrive for Business (Administrator) connectors from our system 
- We also deactivated all scheduled transfers involving those connectors 
Meaning?
- Users will still be able to see Migrations that involved these connectors, but they will be presented with this warning (see screenshot): Connectors don't exist anymore! Your (source|destination) connector, Unknown ("Test"), for this migration does not exist. This means you will not be able to edit or stage any of the schedules. 
- Users will still be able to download any reports they may have or see the stats and such. 
- Users will not see their SharePoint Online or OneDrive for Business (Administrator) connectors in the Transfer Wizard. 
- Users will have the unified Office 365 connector available for their migration needs. 
Let me know if you have any questions about this announcement.


## DEPLOY PRODUCTION - frontend & backend @v1.16.0
...
## DEPLOY PRODUCTION - backend @v1.15.11
...
## DEPLOY PRODUCTION - frontend @ v1.15.4
...
## DEPLOY PRODUCTION - backend @ v1.15.10
Mover team! Just deployed changes improving experience to some of our users.
### User/Support Impact
...
## DEPLOY PRODUCTION - backend @ v1.15.9
...
## DEPLOY PRODUCTION - frontend @ v1.15.3
...
Mover team! A small frontend deploy (smile)
### User/Support Impact
