...
8. Sync other users and groups to Azure AD. 
...
If the identity wasn't found in Azure Active Directory, the Azure Active Directory fields will be empty. The FoundInAzureAD field will be false and ReasonNotFoundInAzureAD will contain a reason code. 
...
|ReasonNotFoundInAzureAD  <br/> |Active Directory  <br/> |The reason why we didn't find the account in Azure Active Directory. The reason can be: PrincipalNotFound - Unable to locate the identity in Azure AD. AdalExceptionFound - Authentication failure to Azure AD. UnknownException - Unexpected error occurred. Details are in the SMAT.log file. This is empty if FoundInAzureAd is true.  <br/> |
