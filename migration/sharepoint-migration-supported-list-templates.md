...
> [!NOTE]
> Sites Pages (for example Wiki Page Library) migration is available only when the source selected is _all lists, libraries, pages, and web parts_ as SPMT treats them as part of the whole site.
